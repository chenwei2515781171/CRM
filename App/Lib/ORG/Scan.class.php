...
<html lang="en">
  <head>
    ...
    <meta name="author" content="禹酒CRM">
      ...
      <form action="" method="post" class="form-signin">
		<fieldset>
			...
			<div class="row-fluid wukong">
				<div class="span3"><img style="height:50px;" src="./Public/img/logo_img.png" alt="禹酒CRM"/></div>
				<div class="span9">
					<p>禹酒CRM &copy; 龙讯互动信息有限公司 2013</p>
					<p><small>
						<a href="http://5kcrm.com/index.php?m=doc" target="_blank">使用帮助</a>
						<span class="muted">&middot;</span>
						<a href="http://www.longsunhd.com/" target="_blank">技术支持</a>
						<span class="muted">&middot;</span>
