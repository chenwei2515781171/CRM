<?php 
	class paymentorderViewModel extends ViewModel{
		public $viewFields = array(
			'paymentorder'=>array('paymentorder_id','name','money','status','payables_id','owner_role_id','delete_role_id','is_deleted','delete_time','description','pay_time','pay_type','creator_role_id','create_time','update_time', '_type'=>'LEFT'),
