<?php 
	class ReceivingorderViewModel extends ViewModel{
		public $viewFields = array(
			'receivingorder'=>array('receivingorder_id','name','money','status','receivables_id','owner_role_id','delete_role_id','is_deleted','delete_time','description','pay_time','pay_type','creator_role_id','create_time','update_time', '_type'=>'LEFT'),
