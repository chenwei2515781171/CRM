...
<div class="container">
	<div class="page-header">
		<h3 class="text_center"><?php echo L('VIEW'); echo L('SALES_RETURN');?><span class="span_code">—— <?php echo ($assign["info"]["sn_code"]); ?></span></h3>
		<div class="pannel_01">
			<div class="pannel_02">
			...
			<div class="pannel_02 p_3">
				...
				<input class="span2" type="text" value="<?php echo ($assign[info][subject]); ?>">
			</div>
				...
				<tbody>
					...
					<tbody id="view_row">
						<?php if(is_array($assign["product"])): $k = 0; $__LIST__ = $assign["product"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr id="row_<?php echo ($k); ?>">
								<td><input type="text" id="product_name_<?php echo ($k); ?>" value="<?php echo ($vo["product_name"]); ?>"/></td>
								...
								<td><input type="text" id="product_discount_<?php echo ($k); ?>" class="product_discount"/></td>
								<td><input type="text" id="product_tax_rate_<?php echo ($k); ?>" value="<?php echo ($vo["tax_rate"]); ?>"/></td>
								<td><input type="text" id="product_tax_price_<?php echo ($k); ?>" class="tax_price"/></td>
								<td><input type="text" id="product_no_tax_price_<?php echo ($k); ?>" class="no_tax_price"/></td>
								<td><input type="text" id="product_prime_price_<?php echo ($k); ?>" class="prime_price"/></td>
								<td>
									<div class="divSelect">
					...
					<tr>
						...
						<td colspan="13"><input class="normal_input" id="address" type="text" value="<?php echo ($assign["info"]["address"]); ?>"></td>
					</tr>
					<tr>
