					...
					<form class="form-inline" id="searchForm" onsubmit="return checkSearchForm();" action="" method="get">
						<ul class="nav pull-left" style="margin-top:20px">
							...
							<li class="pull-left">
								...
								<input name="a" value="zengsong" type="hidden">
...
$("#zengsongexcel").click(function(){
	if(confirm("你确定要导出赠送数据吗？")){
		...
		var url = "<?php echo U('finance/zengsong');?>&customer="+customer+"&role="+role+"&start_time="+start_time+"&end_time="+end_time+"&act=zsexcel";
