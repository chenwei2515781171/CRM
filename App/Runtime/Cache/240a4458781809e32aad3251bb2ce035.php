				...
				<table class="table table-hover table-striped table_thead_fixed"> 
					...
					<thead> 
						<tr>
							...
							<?php if(C('ismobile') != 1): ?><th><?php echo L('START_DATE_TIME');?></th> 
							<th><?php echo L('END_DATE_TIME');?></th><?php endif; ?>
					...
					<tbody>
						<?php if(is_array($eventlist)): $i = 0; $__LIST__ = $eventlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
								...
								<td><a href="<?php echo U('event/view', 'id='.$vo['event_id']);?>"><?php echo ($vo["subject"]); ?></a></td>
