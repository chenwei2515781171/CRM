					...
					<form class="form-inline" id="searchForm" onsubmit="return checkSearchForm();" action="" method="get">
						<ul class="nav pull-left">
							...
							<li class="pull-left">
								...
								<input name="a" value="ziyongtongji" type="hidden">
		...
		<div  id="an_chart" style="margin-left:10px;">			
			<div id="report_content">
				<table class="table table-hover">
					<thead>
						<tr>
							<th style="text-align:center;height:30px;line-height:30px;border:1px #F0F0F0 solid;" colspan="6">自用品鉴统计</th>
							<th><a href="javascript:void(0);" id="ziyongexcelExport" class="link"> <i class="icon-download"> </i> 导出表格</a></th>
...
$("#ziyongexcelExport").click(function(){
	if(confirm("你确定要导出自用品鉴数据吗？")){
		var customer = $("#customer").val();
		var role = $("#role").val();
		var start_time = $("#start_time").val();
		var end_time = $("#end_time").val();
		var url = "<?php echo U('sales/ziyongtongji');?>&customer="+customer+"&role="+role+"&start_time="+start_time+"&end_time="+end_time+"&act=ziyongexcel";
