		...
		<div class="span12 nav">
				<div class="pull-left">
					<ul class="nav pull-left">		
						<li class="pull-left">
							<a  <?php if((strtolower($_GET['type']) != 'send')): ?>id="delete_receive"<?php else: ?>id="delete_send"<?php endif; ?> class="btn delete" style="margin-right: 8px;"><i class="icon-remove"></i><?php echo L('DELETE');?></a>
						</li>
						<li class="pull-left">
