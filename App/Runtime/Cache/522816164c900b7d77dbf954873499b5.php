								...
								<?php elseif(C('ismobile') != 1): ?>
									<td>
										...
										<?php elseif($v['field'] == 'contacts_id'): ?>
											<a target="_blank" href="<?php echo U('contacts/view','id='.$vo['contacts_id']);?>"><?php echo ($vo['contacts_name']); ?></a></span>
										<?php elseif($v['field'] == 'customer_id'): ?>
											<a target="_blank" href="<?php echo U('customer/view','id='.$vo['customer_id']);?>"><?php echo ($vo['customer_name']); ?></a>
