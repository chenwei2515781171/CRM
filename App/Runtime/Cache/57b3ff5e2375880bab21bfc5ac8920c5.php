...
<div class="container">
     <div class="row row-offcanvas row-offcanvas-left">
        ...
        <form role="form" action="<?php echo U('customer/m_add');?>" method="post" class="form-horizontal">
            <div class="panel panel-default">
               <div class="panel-heading">
                  <h3 class="panel-title text-center">主要信息</h3>
               </div>
               <div class="panel-body">
                    <input type="hidden" name="owner_role_id" value="<?php echo (session('role_id')); ?>">
                   ...
                   <div class="form-group">
                      ...
                      <div class="col-sm-9">
                          <select name="origin" class="form-control">
                            <?php if(is_array($origin_list)): $i = 0; $__LIST__ = $origin_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo); ?>"><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </div>
                   </div>
                   <div class="form-group">
                      ...
                      <div class="col-sm-9">
                          <select name="industry" class="form-control">
                            <?php if(is_array($industry_list)): $i = 0; $__LIST__ = $industry_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo); ?>"><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </div>
                   </div>
                   <div class="form-group">
                      ...
                      <div class="col-sm-9">
                          <select name="ownership" class="form-control">
                            <?php if(is_array($ownership_list)): $i = 0; $__LIST__ = $ownership_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo); ?>"><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </div>
                   </div>
                   <div class="form-group">
                      ...
                      <div class="col-sm-9">
                          <select name="rating" class="form-control">
                            <?php if(is_array($rating_list)): $i = 0; $__LIST__ = $rating_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo); ?>"><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </div>
                   </div>
                    <div class="form-group">
