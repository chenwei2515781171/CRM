...
<div class="container">
	...
	<div class="page-header">
		<h3 class="text_center"><?php echo L('EDIT'); echo L('SALES_RETURN');?><span class="span_code">—— <?php echo ($assign["info"]["sn_code"]); ?></span></h3>
		<div class="pannel_01">
			<div class="pannel_02">
			...
			<div class="pannel_02 p_3">
				...
				<input name="base[subject]" class="span2" id="subject" type="text" value="<?php echo ($assign[info][subject]); ?>">
			</div>
			...
			<table class="table table-bordered" id="no-input-border" border="0" cellpadding="0" cellspacing="1" width="95%">
				<tbody>
					<tr>
						...
						<th style="border: none;float: right;"><input type="button" class="btn btn-primary" onclick="loadDialog()" value="<?php echo L('ADD_GOOD');?>"></th>
					</tr>
					<tr style="background-color:#E0E8FF;text-align:center;">
						<td class="span1">&nbsp;</td>
					...
					<tbody id="view_row">
						<?php if(is_array($assign["product"])): $k = 0; $__LIST__ = $assign["product"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr id="row_<?php echo ($k); ?>">
								...
								<td><input type="text" name="sales[product][<?php echo ($k); ?>][unit_price]" id="product_unit_price_<?php echo ($k); ?>" onkeyup="calculate(<?php echo ($k); ?>)" value="<?php echo ($vo["unit_price"]); ?>"/></td>
