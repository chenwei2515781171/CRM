				...
				<table class="table span7">
					...
					<tbody>
						...
						<?php if(session('?admin')): ?><tr>
							...
							<!--tr>
								<td class="tdleft"><?php echo L('COMMISSTION_PERCENT');?>&nbsp;<span style="color:red;">*</span></td>
								<td>
									<input class="span1" type="text" name="percent" value="<?php echo ($user["percent"]); ?>" id="percent"/> %
								</td>
							</tr-->
						<?php else: ?>
