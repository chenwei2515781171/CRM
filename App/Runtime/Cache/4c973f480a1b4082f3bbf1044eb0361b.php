					...
					<table class="table table-hover table-striped table_thead_fixed">
						...
						<tbody>
							<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
									...
									<td><?php if($vo['isshow'] == 1): ?><span style="color:green;"><i class="icon-ok-circle"></i><?php echo L('SHOW');?></span><?php else: ?><span style="color:red;"><i class="icon-remove-circle"></i><?php echo L('NOT SHOW');?></span><?php endif; ?></td><?php endif; ?>
