					...
					<tbody>
                        ...
                        <?php if($vo['form_type'] == 'textarea' or $vo['form_type'] == 'editor' or $vo['form_type'] == 'address'): if($i%2 != 0): ?><td colspan="2">&nbsp;</td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><?php echo ($vo["html"]); ?><span id="addressTip" style="color:red;"></span></td>
                            </tr>
                        ...
                        <tr>
                            ...
                            <td><input class="user_input" type="text" id="con_name" name="con_name" value="<?php echo ($leads['contacts_name']); ?>"><span id="con_nameTip" style="color:red;"></span></td>
                            <td class="tdleft" ><?php echo L('CELLPHONE');?></td>
                            <td><input class="user_input" id="con_telephone" name="con_telephone" value="<?php echo ($leads['mobile']); ?>" type="text" /><span id="con_telephoneTip" style="color:red;"></span></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input class="user_input" name="con_qq" type="text" value="<?php echo ($leads['qqnumber']); ?>" /></td>
					...
					<tfoot>
						<tr>
							<td style="text-align:center;" colspan="4">
                                ...
                                <input type="checkbox" name="create_business2" value="1"/><?php echo L('AT_THE_SAME_TIME_CREATING_BUSINESS_OPPORTUNITIES');?></td>
						</tr>
					</tfoot>
                </table>
...
<?php if(is_array($field_list[data])): $i = 0; $__LIST__ = $field_list[data];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo['is_validate'] == 1): if($vo['form_type'] != 'box' || $vo['setting']['type'] == 'select'): ?>$("#<?php echo ($vo['field']); ?>").formValidator({
    ...
    $("#state").formValidator({
        ...
        min:1,max:500,
        onshow:"<font style='color:red;'>客户联系地址不能为空！</font>",
        onErrorMin:"客户联系地址不能为空！",
        onErrorMax:"客户联系地址超出最大长度"
     });
    ...
    $("#con_name").formValidator({
        ...
        min:1,max:500,
        onshow:"<font style='color:red;'>首要联系人姓名不能为空！</font>",
        onErrorMin:"首要联系人姓名不能为空！",
        onErrorMax:"首要联系人姓名超出最大长度"
     });
    ...
    $("#con_telephone").formValidator({
        ...
        min:1,max:500,
        onshow:"<font style='color:red;'>客户联系地址不能为空！</font>",
        onErrorMin:"客户联系手机不能为空！",
        onErrorMax:"客户联系手机超出最大长度"
     });
});
</script>
