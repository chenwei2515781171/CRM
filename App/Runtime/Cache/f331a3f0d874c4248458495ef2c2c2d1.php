...
<div class="container">
	...
	<div class="row" id="widgets">
        <?php if(empty($widget)): ?><div class="span12">
            ...
            <div class="span12">
                <?php if(!empty($announcement_list)): ?><p class="wel_h3"><img src="__PUBLIC__/img/index_notice.png" style="width:17.5px;"/> <?php echo L('SYSTEM_OF_ANNOUNCEMENT');?></p>
                    ...
                    <?php if(is_array($announcement_list)): $k = 0; $__LIST__ = $announcement_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><p><?php echo ($k); ?>、<span style="font-size: 14px;color:#<?php echo ($vo["color"]); ?>"><?php echo ($vo["title"]); ?></span> <?php if((time()-$vo['update_time']) < 86400*7): ?>&nbsp; <img src="./Public/img/new.gif"><?php endif; ?> &nbsp; (<?php echo L('UPDATE_TIME'); echo (date("Y-m-d H:i",$vo["update_time"])); ?>)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<a href="<?php echo U('announcement/changestatus','id='.$vo['announcement_id']);?>"><a href="<?php echo U('announcement/edit','id='.$vo['announcement_id']);?>"><?php echo L('EDIT');?></a>
                        ...
                        <p><div id="detail<?php echo ($vo['announcement_id']); ?>" class="hide"><?php echo ($vo["content"]); ?></div></p>
						<p></p><?php endforeach; endif; else: echo "" ;endif; ?>
                    </div><?php endif; ?>
                <h3 style="color:#029BE2"><?php echo L('WELCOME_WUKONG_CRM');?>!</h3>
            </div>
